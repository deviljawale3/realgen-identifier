    ...
    <main className="relative min-h-screen bg-[#001a0d] overflow-hidden font-sans">
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-5rem)] w-full max-w-7xl items-center justify-center px-6 py-20">
        <Card className="w-full max-w-lg border-white/10 bg-white/[0.02] backdrop-blur-3xl p-10 md:p-16 rounded-[3rem] shadow-2xl relative overflow-hidden group">
          <div className="absolute -top-24 -right-24 w-48 h-48 bg-[#00FF7F]/10 rounded-full blur-3xl group-hover:bg-[#00FF7F]/20 transition-all duration-700" />
          ...
          <div className="text-center mb-12">
            <div className="w-20 h-20 rounded-2xl bg-[#00FF7F]/10 border border-[#00FF7F]/20 flex items-center justify-center mx-auto mb-8 shadow-2xl shadow-[#00FF7F]/5">
              <Shield className="w-10 h-10 text-[#00FF7F]" />
            </div>
            <h1 className="text-4xl font-black text-white italic tracking-tighter mb-4">Neural Access</h1>
            <p className="text-slate-500 font-bold uppercase tracking-[0.2em] text-[10px]">Verify your identity to proceed</p>
          </div>
          ...
          <div className="grid gap-8">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center ml-4">
                ...
                <Link href="#" className="text-[10px] font-black text-[#00FF7F] uppercase tracking-widest hover:underline">Lost Protocol?</Link>
              </div>
              <div className="relative">
            ...
            <div className="relative py-4 flex items-center gap-4">
              ...
              <span className="text-[10px] font-black text-slate-700 uppercase tracking-widest">Third-Party Auth</span>
              <div className="flex-1 h-px bg-white/5" />
            </div>

            <Button
              variant="outline"
              className="w-full h-16 rounded-2xl border-white/5 bg-white/5 text-white font-black hover:bg-white/10 transition-all flex items-center justify-center gap-4"
            >
            ...
            <div className="text-center">
              <p className="text-xs font-bold text-slate-600 mb-2">New to the forensic labs?</p>
              <Link className="text-xs font-black text-white hover:text-[#00FF7F] transition-colors uppercase tracking-widest border-b border-[#00FF7F]/30" href="/signup">
