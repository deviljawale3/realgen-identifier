...
import { Shield, CheckCircle2, Globe, Lock, Share2, Printer, Download, ChevronRight } from "lucide-react";
                        ...
                        >
                            ...
                            <div className="text-center space-y-4">
                                ...
                                <h1 className="text-5xl md:text-6xl font-black text-white italic tracking-tighter leading-none">
                                    MEDIA STATUS: <span className="text-[#00FF7F]">AUTHENTIC</span>
                                </h1>
                                <p className="text-slate-500 font-medium">This asset has been verified by the RealGen Neural Network.</p>
                            </div>

                            {/* Certificate UI */}
                            <div ref={certificateRef} className="bg-white p-12 md:p-20 rounded-[3rem] shadow-2xl text-slate-950 relative overflow-hidden">
                                {/* Watermark */}
                                ...
                                <div className="relative z-10">
                                    <div className="flex flex-col items-center text-center mb-16">
                                        ...
                                        <h2 className="text-4xl font-black tracking-tighter mb-2 text-[#001a0d]">CERTIFICATE OF TRUTH</h2>
                                        <p className="text-slate-500 font-bold tracking-[0.3em] uppercase text-[10px]">Verification ID: {params.id}</p>
                                    </div>

                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16 border-y border-slate-100 py-12">
                                        <div className="space-y-8">
                                            <div>
                                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-2">Confidence Level</label>
                                                <p className="text-3xl font-black text-[#00FF7F]">99.82%</p>
                                            </div>
                                            <div>
                                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-2">Neural Scan Verdict</label>
                                                <p className="text-lg font-bold text-[#001a0d]">Zero Synthetic Artifacts Detected</p>
                                            </div>
                                        </div>
                                        <div className="space-y-8">
                                            <div>
                                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-2">Scan Signature</label>
                                                <p className="text-sm font-mono font-bold text-[#001a0d]">SHA-256: 8f2a...91b0</p>
                                            </div>
                                            <div>
                                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-2">Origin Date</label>
                                                <p className="text-lg font-bold text-[#001a0d]">{new Date().toLocaleDateString()}</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex flex-col items-center text-center gap-6">
                                        <div className="flex items-center gap-3 px-6 py-3 rounded-xl bg-slate-900 text-white">
                                            ...
                                            <span className="text-xs font-black uppercase tracking-widest">End-to-End Encrypted Verification</span>
                                        </div>
                                        <p className="text-[10px] text-slate-400 font-bold uppercase tracking-[0.3em]">Authorized by RealGen Identification Systems</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-wrap justify-center gap-6 print:hidden">
                                ...
                                >
                                    <Download className="w-5 h-5" /> {isGenerating ? 'Generating...' : 'Download PDF Proof'}
                                </Button>
                                <Button
                                    onClick={handleShare}
                                    variant="outline"
                            ...
                            <div className="pt-20 text-center print:hidden">
                                <p className="text-slate-500 text-sm font-medium mb-4">Want to verify your own files?</p>
                                <Button asChild variant="link" className="text-[#00FF7F] font-black uppercase tracking-widest text-xs">
